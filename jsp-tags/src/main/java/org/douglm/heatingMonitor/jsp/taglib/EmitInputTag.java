 ...
 */
public class EmitInputTag extends NameScopePropertyTag {
  ...
  public int doEndTag() {
    try {
      ...
      final var val = (Input)getObject(false);

      final JspWriter out = pageContext.getOut();

      outInput(out, getIndent(), getTagName(),
                             getFull(), val);
    } finally {
   ...
   */
  public static void outInput(final JspWriter out,
                                 final String indent,
